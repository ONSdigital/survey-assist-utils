...
# Original input data:
#unique_id,sic_section,sic2007_employee,sic2007_self_employed,sic_ind1,sic_ind2,sic_ind3,sic_ind_code_flag,soc2020_job_title,soc2020_job_description,sic_ind_occ1,sic_ind_occ2,sic_ind_occ3,sic_ind_occ_flag
#EV000012,-9,A CHARITY WHICH AIMS TO MAINTAIN WILDLIFE HABITATS  ENGAGE THE PUBLIC TO LEARN ABOUT LOCAL WILDLIFE  CAMPAIGNING AND POLICY WORK ABOUT LONDON S WILDLIFE,-9,91040,94990,NA,CC,COMMUNITY LEARNING OFFICER,ENVIRONMENTAL EDUCATION FOR FAMILIES  GROUPS   SCHOOLS FOR A LOCAL CHARITY  WORKING WITH VOLUNTEERS TO MAINTAIN A WILDLIFE GARDEN,91040,94990,NA,CC
